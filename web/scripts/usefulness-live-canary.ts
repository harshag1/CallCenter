...
const DEFAULT_ROOT = resolve(REPOSITORY_ROOT, "benchmarks/voice-long-horizon/.local/usefulness-live-canary-v4");
...
type CanaryPlan = Readonly<{
  ...
  experimentId: "usefulness-live-canary-v4";
  createdAt: string;
  sourceCommit: string;
  sourceTree: string;
  suiteSha256: string;
...
async function prepare(root: string): Promise<void> {
  ...
  const body = Object.freeze({
    ...
    experimentId: "usefulness-live-canary-v4" as const,
