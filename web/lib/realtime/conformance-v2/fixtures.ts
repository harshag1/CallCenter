...
const PROVIDERS: readonly FakeProviderDescriptor[] = Object.freeze([
  ...
  Object.freeze({
    ...
    toolResultWireType: "toolCallCancellation",
...
export function fakeProviderLifecycleTrace(
  ...
  const at = () => ++clock;
  const proof = (wireType: string): ProviderWireEvidence => Object.freeze({
    authority: "provider_wire",
    providerEventId: `${providerId}-event-${++providerEventOrdinal}`,
    wireType,
    observedAtMs: at(),
  });
  ...
  return Object.freeze([
    ...
    Object.freeze({
      ...
      acknowledged: ack,
      evidence: proof(descriptor.sessionCreatedWireType),
    }),
    Object.freeze({ ...base(first, 0), type: "turn.started", turnId: "turn-1", inputId: "input-1", trigger: "audio_commit", evidence: proof(descriptor.turnWireType) }),
    Object.freeze({ ...base(first, 0), type: "response.started", turnId: "turn-1", responseId: "response-1", evidence: proof(descriptor.responseStartedWireType) }),
    Object.freeze({
      ...
      payloadSha256: AUDIO_SHA256, evidence: proof(descriptor.audioWireType),
    }),
    Object.freeze({
      ...base(first, 0), type: "response.audio.delta", turnId: "turn-1", responseId: "response-1",
      audioDeltaId: "audio-1-1", sequence: 1, byteLength: 960, durationMs: 20,
      payloadSha256: "f".repeat(64), evidence: proof(descriptor.audioWireType),
    }),
    Object.freeze({
      ...
      evidence: proof(descriptor.toolWireType),
    }),
    Object.freeze({
    ...
    Object.freeze({
      ...
      toolCallId: "tool-call-1", resultId: "tool-result-1", evidence: proof(descriptor.toolResultWireType),
    }),
    Object.freeze({
      ...
      totalTokens: 120, evidence: proof(descriptor.usageWireType),
    }),
    Object.freeze({
      ...base(first, 0), type: "response.terminal", turnId: "turn-1", responseId: "response-1",
      status: "completed", evidence: proof(descriptor.terminalWireType),
    }),
    ...
    Object.freeze({
      ...
      evidence: proof(descriptor.sessionResumedWireType),
    }),
    Object.freeze({ ...base(second, 1), type: "turn.started", turnId: "turn-2", inputId: "input-2", trigger: "audio_commit", evidence: proof(descriptor.turnWireType) }),
    Object.freeze({ ...base(second, 1), type: "response.started", turnId: "turn-2", responseId: "response-2", evidence: proof(descriptor.responseStartedWireType) }),
    Object.freeze({
    ...
    Object.freeze({
      ...
      totalTokens: 180, evidence: proof(descriptor.usageWireType),
    }),
    Object.freeze({
      ...
      evidence: proof(descriptor.terminalWireType),
    }),
