...
const TURNS: BenchmarkScenario["caller"]["turns"] = [
  ...
  turn(14, "independent_clearance", "The export desk issued token C I T E S eight eight four one. The clearance token ends at four one; do not append the crate identifier. Validate that token against the committed hold for A seventy-one.", ["verification", "task"], ["Validate CITES-8841 only after the courier hold exists."]),
