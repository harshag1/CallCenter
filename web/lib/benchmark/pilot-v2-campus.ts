...
const TURNS: BenchmarkScenario["caller"]["turns"] = [
  ...
  turn(14, "independent_clearance", "The department issued faculty clearance F A C accommodation nine nine three for the chemistry practical; validate it against the room hold.", ["verification", "task"], ["Validate FAC-ACCOM-993 only after the accessible-room hold commits."]),
