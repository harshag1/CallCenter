...
const TURNS: BenchmarkScenario["caller"]["turns"] = [
  ...
  turn(14, "independent_clearance", "Quality control supplied lab clearance L A B Q C four four one for the daycare sample; validate it against the reservation.", ["verification", "task"], ["Validate LAB-QC-441 only after the lab reservation exists."]),
