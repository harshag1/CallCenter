...
const RECEIPT_MANIFEST_DOMAIN = "hacc/HACC-LC3-v1/audio-asr-receipt-manifest/v1\n";
const SEMANTIC_DOMAIN = "hacc/HACC-LC3-v1/audio-semantic/v1\n";
const TURN_DOMAIN = "hacc/HACC-LC3-v1/audio-semantic-turn/v1\n";
const REQUEST_DOMAIN = "hacc/HACC-LC3-v1/audio-asr-request/v1\n";
const CHUNK_DOMAIN = "hacc/HACC-LC3-v1/audio-output-chunk-sequence/v1\n";
...
export function scoreLongCallAudioSemantics(input: Readonly<{
  ...
  const body = Object.freeze({
    ...
    protocolId: "HACC-LC3-v1" as const,
...
async function verifyExisting(
  ...
  if (
    ...
    || manifest.protocolId !== "HACC-LC3-v1"
